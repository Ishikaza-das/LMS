          ...
          <form className='text-white space-y-6 py-8' onSubmit={saveVideo}>
            <div className='grid grid-cols-1 gap-6'>
              <div className='space-y-2'>
                ...
                <Input type="text" value={input.title} name="title" onChange={handelInputChange}/>
              </div>

              <div className='space-x-2 flex items-center'>
                <Switch checked={input.status === "public"} onCheckedChange={(checked) => setInput({...input, status: checked ? "public" : "private"})}/>
              ...
              <div>
                ...
                {selectedVideo && (
                  <div className="mt-4 space-y-2">
                    <p className="text-sm text-gray-300">Selected: {selectedVideo.name}</p>
                    <video 
              ...
              {
                loading ? <Button className="bg-blue-500 text-xl" type="submit"><Loader2 className='animate-spin'/>Saving...</Button> : <Button className="bg-blue-500 text-xl" type="submit">Save</Button>
              }
            </div>
          </form>
        </div>
