  ...
  return (
    <div className="flex flex-col xl:flex-row gap-10 pt-4">
      <div className="w-full xl:w-1/2 pt-4">
        {currentVideo ?
          (<video className="w-full md:h-[300px] lg:h-[400px]" controls src={currentVideo}/>):(
            <div className="w-full md:h-[300px] lg:h-[400px] bg-gray-800 flex items-center justify-center">
              <p className="">No Video Selcted</p>
            </div>
          )}
      </div>
